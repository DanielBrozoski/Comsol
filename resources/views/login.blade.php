...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <style>
            ...
            .container .row .content form .btn{background-color: #0d3625 }
                        ...
                        <form method="post" action="{{ route('login') }}">
                            ...
                            <div class="form-row {{ $errors->has('email') ? ' has-error' : '' }}">
                                <div class="form-group col-md-12">
                                    <label for="inputUsermame" class="col-form-label">Usuário</label>
                                    <input type="username" class="form-control" id="inputUsername" value='{{ old('email') }}' placeholder="Digite o seu usuário" required autofocus>
                                ...
                                <div class="form-group col-md-12 {{ $errors->has('password') ? ' has-error' : '' }}">
                                    ...
                                    <input type="password" class="form-control" id="inputPassword" placeholder="Insira sua senha" required>
                            ...
                            <div class="form-group" >
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="checkbox" {{ old('remember') ? 'checked' : '' }}> Lembrar - me
                                    </label>
                                    <label class="linkEsqueceu pull-right"><a href="{{ route('password.request') }}">Esqueceu sua senha?</a> </label>
                                </div>
                            </div>
